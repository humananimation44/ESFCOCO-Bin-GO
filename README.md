...
We also utilized Perplexity as a learning and coding assistant for brainstorming, explaining Mediapip/OpenCV concepts, and troubleshooting; we did not train the underlying hand model, other than OpenCV code, we used perplexity simply to troubleshoot in extreme matters, with minimal use. 

OpenCV Code explanation-
Adopting the camera-tracking model from MediaPipe, we 
